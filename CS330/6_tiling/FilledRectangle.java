...
class FilledRectangle extends Shape
{
   ...
   public FilledRectangle(java.awt.Point p1, java.awt.Point p2)
    {
	super(Color.black);
	setCorners (p1, p2);
    }

   public FilledRectangle(java.awt.Point p1, java.awt.Point p2, Color c)
    {
	super(c);
	setCorners (p1, p2);
    }
   ...
   public String toString()
    {
	return "FilledRectangle: (" + _rect.x + "," + _rect.y + ") +"
	    + _rect.width + "+" + _rect.height;
    }

   public Object clone() 
    {
	FilledRectangle copy = new FilledRectangle(getColor());

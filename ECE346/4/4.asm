...
*OC2 INTERRUPT INITIALIZATION        
	...
	LDAA	OPTION
	ORAA	%10000000	;Power up A2D
	STAA	OPTION

	LDAA	#%00100011	;use PE_3 as the a2d input
	STAA	ADCTL	 	;clear CCF, set channel to begin conversion
...
* Display the reset position
DISP3	LDAA    CONT1
        STAA    COMBASE
        LDAA    #D_COUNT
        STAA    CNTR
LOOPC3  LDAA    CNTR          ; 4ms delay
        BNE     LOOPC3
* Output first 8 characters       
        LDAB    #DATA_LEN
	LDX	#DATA3
...
* Display mode at the bottom
DISP4   LDAA    CONT2
        STAA    COMBASE

        LDAA    #D_COUNT
        STAA    CNTR
LOOPC4  LDAA    CNTR                ; 4ms delay
        BNE     LOOPC4

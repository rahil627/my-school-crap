...
Perl 5.8.8
PHP 5.2.4
Database and Directory Services 		MySQL 5.0.45
...
my website begins here


<ul>

	<li class="active"><a href="http://rahilpatel.com/" accesskey="1" title="">Home</a></li>
	<li><!--<img src="images/web/page_edit.png">--><a href="http://rahilpatel.com/files.php" accesskey="2" title="">Notes</a></li>
	<li><a href="http://rahilpatel.com/about.php" accesskey="3" title="">About</a></li>
</ul>
